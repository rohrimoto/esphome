...
#define USE_ESP32_BLE_SERVER_ON_PASSKEY_REQUEST
#define USE_ESP32_BLE_SERVER_ON_PASSKEY_NOTIFICATION
#define USE_ESP32_BLE_SERVER_ON_NUMERIC_COMPARISON_REQUEST
